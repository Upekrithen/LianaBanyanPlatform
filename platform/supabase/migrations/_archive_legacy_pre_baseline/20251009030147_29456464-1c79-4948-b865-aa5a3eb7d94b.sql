-- Create user profiles table for SSO members (if not exists)
...
DROP POLICY IF EXISTS "Users can view own votes" ON public.user_votes;
...
DROP POLICY IF EXISTS "Users can view own pledges" ON public.kickstarter_pledges;
...
-- RLS Policies for kickstarter_pledges
