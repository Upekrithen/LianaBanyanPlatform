...
(
  ...
  'Verify that Caithedral Effect holds at Tier A (default plan). Prove the floor.',
  'Run LB Frame Caithedral Effect benchmark (R10/R11/R13 question bank) at Tier A (default Claude Code plan or equivalent). Document cold-start vs HOT accuracy. Submit empirical-receipt JSON showing ≥30pp Caithedral Effect lift. This is the foundational floor verification — Tier A is the universal access tier, and this Bounty confirms that the Caithedral Effect is substrate-driven, not plan-dependent.',
  ...
  'open',
  TRUE, 101,
  'Empirical-receipt JSON with ≥30pp Caithedral Effect lift + AI model + question bank version + run timestamp',
...
(
  ...
  'Run LB Frame Caithedral Effect benchmark at Tier B (Claude Max or equivalent recommended plan). Compare to a Tier A floor receipt. Verify that Reckoning velocity is ≥1.5× faster than Tier A and Caithedral Effect lift is preserved (≥30pp). Documents the value proposition of the recommended plan tier in measurable, reproducible terms.',
