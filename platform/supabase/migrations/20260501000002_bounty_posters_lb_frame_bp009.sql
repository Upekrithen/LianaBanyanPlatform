...
(
  ...
  'Replicate the KN042 substrate-routed memory expansion test on at least two of: Apple Silicon (M3/M4), NVIDIA H100, Cerebras CS-2/CS-3, Groq LPU, AMD MI300X. Report: (1) tokens/second, (2) cost per token, (3) Cathedral Effect quality gain vs cold-start baseline, (4) Conductor model-tier routing savings. Each approved silicon variant earns full reward.',
...
(
  ...
  'Produce a complete cross-reference mapping every substrate primitive (Wrasse, Conductor''s Baton, Cathedral Effect, Augur, Furnace, Slow Blade, Pheromone, Stone Tablet, CheckBook Suite, Catechist) to the relevant NIST AI RMF 1.0 function, category, and subcategory. Verified by Catechist for completeness.',
...
(
  ...
  'Run the Cathedral Effect R10/R11 benchmark with LB substrate on Anthropic Claude Haiku (or equivalent entry-level tier), demonstrating it achieves quality scores within 10% of Sonnet on knowledge-retrieval questions. This is the empirical anchor for the Anthropic partner-lane Wave 1 conversation.',
