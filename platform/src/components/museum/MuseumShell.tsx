...
interface MuseumShellProps {
  ...
  hideFabs?: boolean;
  /** Hide only the LRHGuide FAB, keeping CephasFAB visible */
  hideLRHGuide?: boolean;
}
...
export function MuseumShell({ children, hideFabs = false, hideLRHGuide = false }: MuseumShellProps) {
