/**
 * HEOHOFlipCard — The Museum's single hero card (FRONT ONLY).
 *
 * All back modes have been extracted into submarine door pages:
 *   /enter       → EnterDoors
 *   /watch       → WatchFable
 *   /why-no-ads  → WhyNoAds
 *   /why-no-vc   → WhyNoVC
 ...
 *   /yvaine      → YvaineClip
 *
 * FRONT: Rotating quotes, white/green HEOHO, No Ads · COOPERATIVE COMMERCE · No V.C.
 *        Two buttons: ENTER and WATCH. Yvaine SHINE sequence → keyhole → Speak Friend.
 *
 * Yvaine is quote #3. No HEOHO quote in rotation (it's on the card).
 * No comma: "Help Each Other Help Ourselves" — punctuation IS the point.
 */
      ...
      <div className="relative w-full" style={{ aspectRatio: "5/7" }}>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-6 pt-5 pb-5" style={{ aspectRatio: "5/7" }}>
            ...
            {/* Everything below the quote fades during darkening phase */}
            ...
            </div>{/* end darkening fade wrapper */}
          </div>
...
/**
 * CornerArt — Decorative LB filigree in each corner of the Deck Card.
 * TL: Level 1 Circle (Credit), TR: Level 2 Square (Mark),
 * BL: Level 3 Triangle (Joule), BR: Level 4 Circle (Credit)
 */
function CornerArt() {
