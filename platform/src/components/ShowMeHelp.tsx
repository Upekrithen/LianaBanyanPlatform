...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: '🌱',
    topics: [
      { id: 'preorder-pledge', icon: '🎁', title: 'PreOrder Pledge', subtitle: 'Fund before it exists', content: '**PreOrder Pledge — Buy a Patent**\n\nThis is how innovation gets funded on the platform.\n\n**PreOrder Pledge:**\nCommit to buy a product/service when it\'s ready. You\'re not paying now — just reserving. This helps creators know there\'s demand before they invest time.\n\n**Buy a Patent:**\nSome innovations are available as fractional patent investments. Own a piece of the intellectual property and share in licensing revenue.' },
      ...
      { id: 'how-pledges-work', icon: '🤝', title: 'How Pledges Work', subtitle: 'No payment until delivery', content: '**You don\'t pay until the project delivers.**\n\nWhen you pledge:\n1. Your commitment is recorded\n2. Creator sees demand is real\n3. When ready, you\'re notified\n4. Then you complete the purchase\n\n**If project fails:** Your pledge is released, no charge.\n\n**Why this works:** Creators get validation before investing. Backers get products they actually want.' },
      { id: 'patent-investment', icon: '📜', title: 'Patent Investment', subtitle: 'Own intellectual property', content: '**Invest in patents, share in licensing.**\n\nThe platform has 210 formal patent claims across 7 applications. Some are available for fractional investment.\n\n**What you get:**\n• Fractional ownership of the patent\n• Share of any licensing revenue\n• Voting rights on licensing decisions\n\n**This is real IP investment** — not speculation. Patents are legal property with enforceable rights.' },
    ]
  },
];
