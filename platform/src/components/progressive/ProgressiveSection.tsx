  ...
  return (
    ...
    >
      ...
      <button
        ...
        title="Drop a Beacon"
      >
        <Bookmark className="w-4 h-4 text-white/40 group-hover:text-primary transition-colors" />
      </button>
      ...
      {showBeaconDialog && (
        ...
        >
          ...
          <button
            ...
            className="w-full mt-2 py-1 text-xs text-white/40 hover:text-white/60"
          >
            Cancel
          </button>
        </motion.div>
            ...
            <div className="flex flex-wrap gap-3">
              {branchLinks.map((link, idx) => (
                ...
                >
                  ...
                  <ExternalLink className="w-3 h-3 text-white/40 group-hover:text-primary" />
                </a>
              ))}
            </div>
          </motion.div>
