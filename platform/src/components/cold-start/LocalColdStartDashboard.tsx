...
const INITIATIVES: InitiativeInfo[] = [
  ...
  { id: 'household_concierge', name: 'Household Concierge', description: 'World-class home management' },
  ...
  { id: 'jukebox', name: 'JukeBox', description: 'Music licensing and creator contracts' },
