...
function buildShareContent(
  ...
  switch (moment) {
    ...
    default:
      return {
        text: `Check out Liana Banyan — a cooperative platform where creators keep 83.3% of every sale, backed by 1,401 patent claims. $5/year. No speculation. Just services.`,
        url,
        hashtags,
      };
  }
