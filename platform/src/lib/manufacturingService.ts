...
export const SAMPLE_MODULES: ManufacturingModule[] = [
  ...
  { id: "m3", moduleType: "injection_mold", displayName: "Injection Molding", description: "Mass production plastics — requires tooling investment", primaryOperatorUserId: null, secondaryOperatorUserId: null, backupOperatorUserId: null, capacityPerDay: 200, currentQueue: 0, processPioneerUserId: null, processPioneerName: null, status: "inactive", location: null, createdAt: "2026-01-01" },
