  ...
  // ─── CHAPTER 3: GROWTH & MARKETING ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "V.C. money comes with strings: 10x return demands force unsustainable growth, exit pressure means selling you in 5-7 years, and each funding round dilutes everyone. We're funded by 8 provisional patents with 1,754 innovations and started with $1,000. No burn rate. We own 100% — forever.",
  ...
  // ─── CHAPTER 5: GOVERNANCE & TRUST ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "8 provisional applications filed as a micro-entity ($65 each). 1,754 innovations documented. This is the cooperative's runway — IP as a shared asset instead of venture capital debt. 60% of Founder patents go to the platform.",
  ...
  // ─── CHAPTER 9: SHADOW MARK DEMAND SIGNALING ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "The mechanism that distributes crystallized Shadow Marks proportionally across the patent portfolio. When your Shadow Marks crystallize into real Marks, their value is backed by a proportional slice of the cooperative's 1,754 innovations. This creates a direct link between member demand signaling and IP asset allocation — the portfolio funds what people actually want built.",
    ...
    entries: [
      {
        ...
        answer: "Propagating a canonical number or fact across every file that references it. When the innovation count changes from 1,730 to 1,754, Pollination means finding and updating every source file — stats hooks, blueprints, metrics, landing pages, FAQ entries, press pages — so the entire platform shows one consistent truth. Named for how bees carry pollen between flowers: one source of truth, distributed everywhere.",
