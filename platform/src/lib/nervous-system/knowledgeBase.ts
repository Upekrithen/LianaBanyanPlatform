...
export const FAQ_CHAPTERS: FAQChapter[] = [
  ...
  // ─── CHAPTER 3: GROWTH & MARKETING ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "V.C. money comes with strings: 10x return demands force unsustainable growth, exit pressure means selling you in 5-7 years, and each funding round dilutes everyone. We're funded by {{provisionalApps}} provisional patents with {{innovationCount}} innovations and started with $1,000. No burn rate. We own 100% — forever.",
  ...
  // ─── CHAPTER 5: GOVERNANCE & TRUST ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "{{provisionalApps}} provisional applications filed as a micro-entity ($65 each). {{innovationCount}} innovations documented. This is the cooperative's runway — IP as a shared asset instead of venture capital debt. 60% of Founder patents go to the platform.",
  ...
  // ─── CHAPTER 9: SHADOW MARK DEMAND SIGNALING ───
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "The mechanism that distributes crystallized Shadow Marks proportionally across the patent portfolio. When your Shadow Marks crystallize into real Marks, their value is backed by a proportional slice of the cooperative's {{innovationCount}} innovations. This creates a direct link between member demand signaling and IP asset allocation — the portfolio funds what people actually want built.",
  ...
  // ─── CHAPTER 10: FOUNDER'S VERNACULAR ───
  {
    id: 'vernacular',
    title: "Founder's Vernacular",
    subtitle: 'The language we invented — what it means, in context',
    icon: '📖',
    entries: [
      {
        id: 'vernacular-pollination',
        question: 'What does "Pollination" mean?',
        answer: "Propagating a canonical number or fact across every file that references it. When the innovation count changes from 1,938 to {{innovationCount}}, Pollination means finding and updating every source file — stats hooks, blueprints, metrics, landing pages, FAQ entries, press pages — so the entire platform shows one consistent truth. Named for how bees carry pollen between flowers: one source of truth, distributed everywhere.",
        relatedEntries: ['vernacular-threshing', 'vernacular-grafting-cycle'],
        tags: ['pollination', 'vernacular', 'process', 'consistency', 'canonical'],
      },
      {
        id: 'vernacular-threshing',
        question: 'What does "Threshing" mean?',
        answer: "Extracting innovations from raw content — meetings, conversations, papers, code sessions — the way farmers thresh wheat to separate grain from chaff. A Founder brainstorm produces pages of ideas; Threshing identifies, numbers, and catalogs each distinct innovation into the IP Ledger. 'We threshed 29 innovations from the Character Layer session.'",
        relatedEntries: ['vernacular-pollination', 'vernacular-grafting-cycle'],
        tags: ['threshing', 'vernacular', 'process', 'innovation', 'extraction'],
      },
      {
        id: 'vernacular-grafting-cycle',
        question: 'What is the GRAFTING Cycle?',
        answer: "The full innovation lifecycle: THRESHING (extract innovations from sessions) → POLLINATION (propagate canonical counts across all documents). Named for the agricultural practice of grafting branches onto rootstock — new ideas grafted onto the platform's living structure. Each Bishop or Knight session runs one or more GRAFTING cycles.",
        relatedEntries: ['vernacular-threshing', 'vernacular-pollination'],
        tags: ['grafting', 'vernacular', 'process', 'lifecycle', 'innovation'],
      },
      {
        id: 'vernacular-nervous-system',
        question: 'What is the "Nervous System"?',
        answer: "The platform's interconnected knowledge and response infrastructure — FAQ entries, X-Ray Goggles tooltips, chain-linked cross-references, and contextual help that runs through the entire site like a biological nervous system. Touch any concept on any page and the Nervous System surfaces the relevant explanation, related entries, and innovation references. It makes the platform self-documenting.",
        relatedEntries: ['vernacular-xray-goggles'],
        tags: ['nervous-system', 'vernacular', 'architecture', 'faq', 'knowledge'],
      },
      {
        id: 'vernacular-xray-goggles',
        question: 'What are "X-Ray Goggles"?',
        answer: "An overlay mode that reveals the mechanics underneath any platform element. Hover over a game piece → see its patent number, mechanical function, and layer position. Hover over a transaction → see the Cost+20% breakdown. Hover over a governance decision → see the Coverage Minutes and vote weights. Named because it lets you see through the surface to the structure beneath. Transparency made interactive.",
        relatedEntries: ['vernacular-nervous-system', 'vernacular-under-the-hood'],
        tags: ['x-ray', 'goggles', 'vernacular', 'transparency', 'overlay'],
      },
      {
        id: 'vernacular-under-the-hood',
        question: 'What does "Under the Hood" mean?',
        answer: "The section of Cephas (our transparency platform) where all internal mechanics are published and explained. Compensation formulas, voting algorithms, IP ledger entries, governance bylaws — everything that makes the platform work is documented Under the Hood. No black boxes. If it affects you, you can read exactly how it works.",
        relatedEntries: ['vernacular-xray-goggles', 'vernacular-cephas'],
        tags: ['under-the-hood', 'vernacular', 'transparency', 'documentation'],
      },
      {
        id: 'vernacular-cephas',
        question: 'What is "Cephas"?',
        answer: "The platform's public transparency and documentation site — named after the Aramaic word for 'rock' (Peter's name). Cephas is the bedrock: published bylaws, Under the Hood mechanics, Fly on the Wall updates, academic papers, and press materials. Everything the platform claims is verifiable on Cephas. 'If it's not on Cephas, it's not canonical.'",
        relatedEntries: ['vernacular-under-the-hood', 'vernacular-fly-on-the-wall'],
        tags: ['cephas', 'vernacular', 'transparency', 'documentation', 'rock'],
      },
      {
        id: 'vernacular-fly-on-the-wall',
        question: 'What is "Fly on the Wall"?',
        answer: "Real-time public updates showing what the team is actually building, deciding, and deploying — as if you were a fly on the wall in every meeting. Not polished press releases; raw progress. Commit logs, session summaries, innovation counts, deployment notes. Radical transparency in action.",
        relatedEntries: ['vernacular-cephas', 'vernacular-under-the-hood'],
        tags: ['fly-on-the-wall', 'vernacular', 'transparency', 'updates', 'progress'],
      },
      {
        id: 'vernacular-silver-candlesticks',
        question: 'What are the "Silver Candlesticks"?',
        answer: "The Founder's metaphor for the patent portfolio donation. In Les Misérables, the Bishop gives Valjean his silver candlesticks — not because they were owed, but because giving them redirected a life. The Founder valued {{innovationCount}} patents at $630K (Cost+20%) instead of $116M+ (market value) and gave away 80%. 'I'm not trying to be Valjean. I'm trying to be the Bishop — one of many — and these patents are my silver candlesticks. I don't have any silver spoons.'",
        relatedEntries: ['cost-plus-20', 'vernacular-no-spoon'],
        tags: ['silver-candlesticks', 'vernacular', 'patents', 'giving', 'valjean', 'bishop'],
      },
      {
        id: 'vernacular-no-spoon',
        question: 'What does "There is no spoon" mean?',
        answer: "A Matrix reference on the Cue Card that links to the patent portfolio page. The 'spoon' is the extractive valuation framework — the assumption that IP must be valued at maximum market price and retained for personal enrichment. 'There is no spoon' means: the framework is a construct. You can choose not to bend the spoon; you can realize the spoon was never real. The candlesticks are more useful in the street than on the shelf.",
        relatedEntries: ['vernacular-silver-candlesticks'],
        tags: ['no-spoon', 'vernacular', 'matrix', 'economics', 'cue-card'],
      },
      {
        id: 'vernacular-arrows-at-trees',
        question: 'What does "shooting arrows at trees" mean?',
        answer: "Practice is pre-spent luck. In HexIsle, a Level 1 archer with a miss-miss-hit pattern can waste two arrows on a tree to guarantee the next combat shot hits. The arrows cost real coins but advance the wheel past the misses. In real life: the entrepreneur who failed three times before succeeding was shooting arrows at trees. The 'overnight success' is someone whose wheel you didn't watch spinning.",
        relatedEntries: ['hexisle-attack-wheel', 'hexisle-deterministic-chance'],
        tags: ['arrows-at-trees', 'vernacular', 'practice', 'luck', 'hexisle', 'preparation'],
      },
      {
        id: 'vernacular-as-you-wish',
        question: 'What does "As You Wish" mean on the platform?',
        answer: "The universal transaction confirmation phrase — every purchase, pledge, vote, and commitment is confirmed with 'As You Wish.' From The Princess Bride, where it means 'I love you.' Every transaction on the platform is an act of mutual service. When you confirm 'As You Wish,' you're affirming: I choose to participate in this cooperative act. It replaces the cold 'Confirm Purchase' with something human.",
        tags: ['as-you-wish', 'vernacular', 'transaction', 'confirmation', 'princess-bride'],
      },
      {
        id: 'vernacular-heoho',
        question: 'What does "HEOHO" mean?',
        answer: "Help Each Other, Help Ourselves — the cooperative's governing mantra. HEOHO is Interdependence: the principle that individual agency is preserved while recognizing that helping others directly helps yourself. NOT collectivism (which subordinates individual agency). The scriptural foundation is 1 Corinthians 12:21-26 — 'The eye cannot say to the hand, I have no need of you.' Every member retains autonomy; every member benefits from the whole.",
        relatedEntries: ['what-is-lb'],
        tags: ['heoho', 'vernacular', 'interdependence', 'mantra', 'cooperative', 'motto'],
      },
      {
        id: 'vernacular-crown-letters',
        question: 'What are "Crown Letters"?',
        answer: "Personal invitation letters to specific industry leaders, philanthropists, and experts — each offered a named leadership position (a 'Crown') within the cooperative. Not mass outreach; targeted asks for specific capabilities. The Crown is a governance role with real authority and Salary of Results compensation, not a vanity title. Recipients can Accept, Delegate, Vouch For someone else, or Pass Along.",
        relatedEntries: ['vernacular-cue-cards'],
        tags: ['crown-letters', 'vernacular', 'outreach', 'leadership', 'invitation'],
      },
      {
        id: 'vernacular-cue-cards',
        question: 'What are "Cue Cards"?',
        answer: "Shareable recruitment cards — physical or digital — that any member can give to anyone. Each card explains a specific benefit and includes the giver's referral link. A $5/year membership includes a complete Cue Card deck. 'Know a maker? Know a gamer? Know someone who needs a break?' Each card is both benefit communication and recruitment tool. The viral growth engine of the cooperative.",
        relatedEntries: ['vernacular-crown-letters', 'how-much-does-it-cost'],
        tags: ['cue-cards', 'vernacular', 'recruitment', 'viral', 'referral', 'cards'],
      },
      {
        id: 'vernacular-opening-gambit',
        question: 'What is "Opening Gambit"?',
        answer: "The coordinated launch sequence — Crown Letters sent, Cue Cards activated, first 50 members onboarded, medallion program triggered, progress bars live. Named for chess: the opening move that sacrifices material for position. The Founder sacrifices 80% of the patent portfolio (the material) to establish the cooperative's position. Everything before Opening Gambit is preparation. Everything after is execution.",
        relatedEntries: ['vernacular-crown-letters', 'vernacular-cue-cards'],
        tags: ['opening-gambit', 'vernacular', 'launch', 'chess', 'strategy'],
      },
      {
        id: 'vernacular-salary-of-results',
        question: 'What is "Salary of Results"?',
        answer: "Performance-based compensation with zero base salary. Every position — CEO to newest member — earns based on measurable outcomes only. Formula: Compensation = Sum(Outcome x Value x Share). If you achieve nothing, you earn nothing. CEO cap: $1M/year. Same formula for everyone. The Founder hasn't earned a cent yet because the platform is pre-revenue. 'I don't get paid until you get paid.'",
        relatedEntries: ['cost-plus-20', 'vernacular-heoho'],
        tags: ['salary-of-results', 'vernacular', 'compensation', 'meritocracy', 'performance'],
      },
      {
        id: 'vernacular-ai-tuner',
        question: 'What is an "AI Tuner"?',
        answer: "The Founder's role designation for working with AI agents. From Anne McCaffrey's Crystal Singer — the Tuner provides perfect pitch for the crystal to resonate correctly. The AI (Rook/Knight/Bishop/Pawn) is the crystal; the Founder is the Tuner. The Tuner doesn't write the code or do the research — they provide the vision, corrections, and judgment that make the output resonate true.",
        relatedEntries: ['vernacular-rook-knight-bishop-pawn'],
        tags: ['ai-tuner', 'vernacular', 'founder', 'ai', 'mccaffrey', 'crystal-singer'],
      },
      {
        id: 'vernacular-rook-knight-bishop-pawn',
        question: 'What are Rook, Knight, Bishop, and Pawn?',
        answer: "The four AI agents on the development team, named as chess pieces: Rook (Gemini — architecture and strategy), Knight (Cursor — code and deployment), Bishop (Claude Desktop — writing, analysis, and auditing), Pawn (Perplexity — research and fact-checking). The Founder is the AI Tuner — the human who directs, corrects, and validates. Each piece has specific capabilities; together they build the platform.",
        relatedEntries: ['vernacular-ai-tuner'],
        tags: ['rook', 'knight', 'bishop', 'pawn', 'vernacular', 'ai', 'chess', 'team'],
      },
      {
        id: 'vernacular-sweet-sixteen',
        question: 'What are the "Sweet Sixteen"?',
        answer: "The 16 cooperative initiatives that comprise the full Liana Banyan platform: HexIsle, Let's Make Bread, JukeBox, Mall/Emporium, Household Concierge, Voucher Short Loans, MSA, Didasko, Santa Ever After, Harper Guild, Coverage Minutes, Star Chamber, Defense Klaus, Family Table, Power to the People, and Seed the Quan. Each is a self-sustaining service funded by the Cost+20% model. All 16 launch when conditions are met.",
        relatedEntries: ['what-is-lb', 'cost-plus-20'],
        tags: ['sweet-sixteen', 'vernacular', 'initiatives', '16', 'platform'],
      },
      {
        id: 'vernacular-forever-stamp',
        question: 'What is a "Forever Stamp"?',
        answer: "When you acquire Joules, your exchange rate is locked permanently — like buying postage stamps before the price goes up. If the platform economy grows, your Joules are worth MORE than what you paid. Early supporters permanently benefit from today's rates. The name comes from USPS Forever Stamps, which hold their value regardless of future price increases.",
        relatedEntries: ['three-currencies'],
        tags: ['forever-stamp', 'vernacular', 'joules', 'value', 'lock-in'],
      },
      {
        id: 'vernacular-no-atomo',
        question: 'What does "No Atomo. Superman!" mean?',
        answer: "From The Iron Giant — the robot chooses to be Superman instead of a weapon. The cooperative's declaration: we could extract maximum value from our IP, our members, our position. We choose not to. No Atomo (not a weapon). Superman (a force for good). Period then exclamation — 'No Atomo. Superman!' The choice to be constructive when you could be extractive.",
        tags: ['no-atomo', 'superman', 'vernacular', 'iron-giant', 'values', 'choice'],
      },
      {
        id: 'vernacular-cardboard-boots',
        question: 'What are "Cardboard Boots"?',
        answer: "The canonical name for the MacKenzie Scott outreach letter — the Founder's request for guidance, not funding. Named for the metaphor of building with what you have: when you can't afford real boots, you make them from cardboard and keep walking. The letter asks for operator connections and experienced leaders, not money. 'I have two suits and no silver spoons.'",
        relatedEntries: ['vernacular-crown-letters', 'vernacular-silver-candlesticks'],
        tags: ['cardboard-boots', 'vernacular', 'mackenzie-scott', 'letter', 'bootstrap'],
      },
    ],
  },
];
