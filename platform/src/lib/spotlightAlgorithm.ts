...
export const SEED_CARDS: SpotlightCard[] = [
  {
    ...
    category: 'featured',
    title: 'Built to Last',
    bodyPreview: '8 Patent Applications · 1,748 Innovations · 47 Creators Identified',
    stats: [
      { label: 'Patents', value: '8', color: '#38a169' },
      { label: 'Innovations', value: '1,748', color: '#38a169' },
  ...
  },
  {
    ...
    bodyPreview: '73 new innovations (#1676-#1748) across 6 technology domains. ~220 formal claims.',
