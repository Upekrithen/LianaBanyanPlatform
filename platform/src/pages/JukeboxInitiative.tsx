  ...
  return (
    ...
    <PortalPageLayout variant="immersive" className="landing-page" xrayId="jukebox-initiative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        {/* The Core Philosophy */}
        <Card className="mb-12 border-l-4 border-l-pink-500 shadow-lg bg-card">
          <CardHeader>
        ...
        {/* The Crown Section */}
        <div className="bg-card rounded-2xl p-8 mb-16 relative overflow-hidden">
        ...
        <div className="bg-muted rounded-2xl p-8 mb-16 border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-card p-4 rounded-lg border border-border shadow-sm">
              ...
              <div className="text-sm text-muted-foreground">Immediate licensing fee (83.3% to artist)</div>
            </div>
            <div className="bg-card p-4 rounded-lg border border-border shadow-sm">
              <div className="text-2xl font-bold text-blue-600 mb-1">Credits</div>
              <div className="text-sm text-muted-foreground">Full platform value & utility</div>
            </div>
            <div className="bg-card p-4 rounded-lg border border-border shadow-sm">
              <div className="text-2xl font-bold text-amber-500 mb-1">Marks</div>
              <div className="text-sm text-muted-foreground">Backed by tangible IP valuation ($525K dev valuation)</div>
            </div>
            <div className="bg-card p-4 rounded-lg border border-border shadow-sm">
          ...
          {activeTab === 'lobbying' && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground">One Take Wonders & Active Lobbying</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted p-4 rounded-lg border border-border flex items-center justify-between opacity-50">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground/70">Dolly Parton & Pitbull</p>
                  </div>
                  <div className="flex items-center gap-4">
        ...
        <div className="bg-card rounded-2xl p-8 mb-16 text-center">
