  ...
  return (
    <div className="landing-page min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        {/* The Crown Section */}
        <div className="bg-white rounded-2xl p-8 mb-16 border border-slate-200 shadow-sm relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-5">
            <Star className="h-48 w-48 text-orange-900" />
          </div>
          <div className="relative z-10">
            <Badge className="bg-slate-800 text-white mb-4">The Crown: Industry Chancellor</Badge>
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Why We Wrote to Dale Dougherty</h2>
        ...
        <div className="bg-slate-100 p-8 rounded-2xl border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">The Blueprints of Losing</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg overflow-hidden border border-slate-200 shadow-inner">
                <div className="bg-slate-800 text-white text-xs font-bold px-3 py-1 text-center">Original Screenshot (Months Ago)</div>
