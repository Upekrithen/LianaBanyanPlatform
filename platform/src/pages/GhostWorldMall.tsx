...
export default function GhostWorldMall() {
  return (
    <PortalPageLayout variant="stage" maxWidth="lg" xrayId="ghost-world-mall">
        <Link to="/" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-white mb-6">
          <ArrowLeft className="w-4 h-4" /> Back
        </Link>
        <div className="text-center py-16">
          <Ghost className="w-16 h-16 mx-auto mb-4 text-amber-400" />
          <h1 className="text-3xl font-bold mb-2">Ghost World Mall</h1>
          <p className="text-slate-400 mb-8">Practice shopping in the risk-free realm</p>
