...
const lbInternalPositions: LBPosition[] = [
  ...
  },
  {
    ...
    description: 'Primary legal architect. Defense Klaus fund. IP protection for 928+ patent claims. Harper Guild ethics oversight.',
    icon: Scale,
    priority: 'critical',
    tier: 'c_suite',
    typicalCompensation: 'Marks-based + participation',
    ...
    keyResponsibilities: [
      ...
      'IP strategy for 928+ patent claims across multiple provisionals',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    description: 'Provisional patent applications. Micro-entity filings ($65 each). 928+ claims across multiple bags.',
    icon: BookOpen,
    priority: 'high',
    tier: 'guild_staff',
