...
const BAG_LABELS: Record<string, { name: string; range: string; claims: number }> = {
  ...
  '7': { name: 'Bag 7 — Full Specs', range: '#1001–#1662', claims: 0 },
};
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-slate-300">
              ...
              <tr className="border-b border-slate-800"><td className="py-2 font-mono">64/006,010</td><td>Mar 15, 2026</td><td className="text-right text-slate-500">TBD</td><td>Full Specs (#1001–#1662)</td></tr>
