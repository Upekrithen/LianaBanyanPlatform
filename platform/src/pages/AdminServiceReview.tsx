      ...
      <Tabs defaultValue="flagged">
        ...
        <TabsContent value="flagged" className="space-y-4">
          {flaggedLinks.length === 0 ? (
            <Card>
              <CardContent className="pt-6">
                <p className="text-center text-muted-foreground">No flagged links</p>
              </CardContent>
            </Card>
          ) : (
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {link.violations_count > 0 && (
                            <Badge variant="outline">{link.violations_count} violations</Badge>
                          )}
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium">
                          ${link.advertised_rate_min || 0} - ${link.advertised_rate_max || 0}/hr
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-muted-foreground">Category</p>
                        <p className="font-medium">{link.lb_rate_category || "Uncategorized"}</p>
                      </div>
                    </div>
        ...
        <TabsContent value="pending" className="space-y-4">
          {pendingLinks.length === 0 ? (
            <Card>
              <CardContent className="pt-6">
                <p className="text-center text-muted-foreground">No pending links</p>
              </CardContent>
            </Card>
          ) : (
