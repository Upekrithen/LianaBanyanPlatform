    ...
    <PortalPageLayout variant="immersive" className="landing-page" xrayId="harper-guild-page">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 text-muted-foreground border-border">Initiative #12</Badge>
        ...
        {/* The Core Philosophy */}
        <Card className="mb-12 border-l-4 border-l-border shadow-lg bg-card">
          <CardHeader>
        ...
        <div className="bg-card rounded-2xl p-8 mb-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <Badge className="bg-muted text-foreground mb-4">The Crown: Harper Prime Mentor</Badge>
        ...
        <Card className="mb-16 border-t-4 border-t-amber-500 shadow-md bg-white">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-center p-6 bg-muted rounded-lg border border-border text-center">
