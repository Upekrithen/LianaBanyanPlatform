 ...
 *
 * All content SEC-safe. No speculative-finance or ownership-claim language.
 */
...
const VALUE_PROP_TOPICS: FlipTopic[] = [
  {
    ...
    icon: DollarSign,
    quickFacts:
      "The platform uses a patent sponsorship model — not venture capital. Your product is backed by the IP portfolio (2,097 patent claims). Sponsors contribute to pools, not to your company. You keep full control. The Cost+20% pricing model means you keep 83.3% of every sale.",
    intermediate:
