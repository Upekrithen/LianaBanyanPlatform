          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <Card className="border-emerald-500/30 bg-emerald-500/5 hover:shadow-md transition-all hover:-translate-y-1">
              <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full space-y-3">
                ...
                <p className="text-sm text-muted-foreground">Total kit value — backed by 21 provisional patents and 2,473 formal claims</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent className="space-y-4 text-center">
            <p className="text-sm text-muted-foreground">
              Backed by our patent portfolio: 21 provisionals, 2,473 formal claims.
            </p>
