...
export default function ShowcasePromotion() {
  return (
    <PortalPageLayout variant="stage" maxWidth="lg" xrayId="showcase-promotion">
        <Link to="/" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-white mb-6">
          <ArrowLeft className="w-4 h-4" /> Back
        </Link>
        <div className="text-center py-16">
          <Megaphone className="w-16 h-16 mx-auto mb-4 text-amber-400" />
          <h1 className="text-3xl font-bold mb-2">Showcase Promotion</h1>
          <p className="text-slate-400 mb-8">Get your store featured on The Daily News</p>
