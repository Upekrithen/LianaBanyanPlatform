...
import { Route, MapPin, Clock, Users, Plus, ArrowRight, Shield, CheckCircle2, Navigation } from "lucide-react";
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                          <div className="flex-1 space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                              ...
                              {r.cost_per_ride && <span>• ${r.cost_per_ride} gas split</span>}
                            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div><label className="text-xs font-medium">Gas Split ($)</label><Input type="number" step="0.01" placeholder="5.00" value={form.cost_per_ride} onChange={(e) => setForm((p) => ({ ...p, cost_per_ride: e.target.value }))} /></div>
                </div>
