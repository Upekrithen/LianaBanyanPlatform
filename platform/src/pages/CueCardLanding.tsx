...
const CUE_CARDS: Record<string, CueCardData> = {
  ...
  'own-patent': {
    ...
    tagline: 'Fractional ownership through sponsorship',
    content: 'Sponsor 5 new members ($25). Receive fractional ownership of 8+ utility patents. Help others = own something real.',
    destination: '/sponsor',
    destinationLabel: 'Sponsor Portal',
    color: 'from-violet-500/30 to-purple-500/20',
    icon: <Key className="w-12 h-12 text-violet-400" />,
    benefits: [
      'Fractional patent ownership',
      '8+ Crown Jewel utility patents',
      'Recorded on immutable ledger',
      'Help others while building wealth',
    ],
  },
  'forever-stamps': {
    id: 'forever-stamps',
    ...
    content: 'Joules lock in today\'s value forever. Like buying postage that never expires. Your work today pays dividends tomorrow.',
