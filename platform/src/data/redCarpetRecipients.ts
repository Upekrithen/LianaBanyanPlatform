...
export const RECIPIENTS: Recipient[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    whyYou:
      "You've spent your career finding founders who see what others miss. This platform was built by an engineer over 37 years — not a pitch deck founder. It has 1,754 documented innovations — 99% utility patents, not design — protected by 1,401 formal claims across 8 provisional applications. Eight definite with 9 more from the first 130 survived a deep dive with no prior art found. Economics constitutionally locked against extraction. The CEO seat was designed for a professional, not the founder's ego. You're the one we built it for.",
    category: "crown",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    whyYou:
      "You write about platform power every day. What happens when a platform constitutionally locks its margin at Cost+20%, gives creators 83.3%, and makes the economics impossible to change? That's not a thought experiment. We built it. Backed by 1,754 innovations and 1,401 formal claims across 8 provisional applications — 8 definite with 9 more from the first 130 survived a deep dive with no prior art.",
    category: "journalist",
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    whyYou:
      "You coined 'platform cooperativism.' We built it. 1,754 innovations — 99% utility patents — protected by 1,401 formal claims across 8 provisional applications. Eight definite with 9 more from the first 130 survived a deep dive with no prior art. This isn't a theory anymore — it's a cooperative with 16 charitable initiatives and a patent portfolio worth $630K declared — $116M pessimist's floor.",
    category: "academic",
  ...
  },
  {
    ...
    whyYou:
      "You theorized peer production and the networked commons. We built the commercial infrastructure for it — a platform where commons-based production meets constitutional economics. Your theory. Our implementation. 1,754 innovations — 1,401 formal claims across 8 provisional applications — proving it works.",
    category: "academic",
    categoryLabel: "Academic Partnership",
...
export const PRESS_OUTLETS: PressOutlet[] = [
  ...
  { id: "techcrunch", name: "TechCrunch", tagline: "Startup disrupts platform economics with constitutional margins", angle: "Startup launch story — 1,754 innovations, 1,401 claims across 8 provisional applications, $5/year membership", launchFlag: "AB" },
