...
export const RECIPIENTS: Recipient[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    whyYou:
      "You write about platform power every day. What happens when a platform constitutionally locks its margin at Cost+20%, gives creators 83.3%, and makes the economics impossible to change? That's not a thought experiment. We built it. Backed by 1,748 innovations and 1,336 formal claims across 7 provisional applications — 8 definite with 9 more from the first 130 survived a deep dive with no prior art.",
    category: "journalist",
  ...
  },
  {
    ...
    whyYou:
      "You theorized peer production and the networked commons. We built the commercial infrastructure for it — a platform where commons-based production meets constitutional economics. Your theory. Our implementation. 1,748 innovations — 1,336 formal claims across 7 provisional applications — proving it works.",
    category: "academic",
    categoryLabel: "Academic Partnership",
...
export const PRESS_OUTLETS: PressOutlet[] = [
  ...
  { id: "techcrunch", name: "TechCrunch", tagline: "Startup disrupts platform economics with constitutional margins", angle: "Startup launch story — 1,748 innovations, 1,336 claims across 7 provisional applications, $5/year membership", launchFlag: "AB" },
