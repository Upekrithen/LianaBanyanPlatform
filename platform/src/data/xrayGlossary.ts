...
export const XRAY_GLOSSARY: Record<string, XRayGlossaryEntry> = {
  ...
  // ─── FOOTER ───
  "platform-footer": {
    explanation: "Platform footer — links to legal, community, and platform tools. 1,336 patent claims, 1,709 innovations. Service sponsorship, not securities.",
  },
  ...
  "why-no-ads-vc": {
    ...
    connectedTo: "Ties to the Herald system (referral bonuses replace ad spend), the patent portfolio (7 provisionals with 1,709 innovations replace VC runway), and the Joules system (early supporters get forever-stamp rates instead of dilution).",
