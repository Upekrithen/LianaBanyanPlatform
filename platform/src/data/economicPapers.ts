...
export const NINE_ECONOMIC_LAWS: EconomicLaw[] = [
  ...
  },
  {
    ...
    principle: 'Locked margins force the derivative of platform benefit with respect to quality to be positive',
    paperId: 'anti-extractive',
    equation: 'dBenefit/dQuality > 0 (when margin is locked)',
  },
  {
    number: 4,
...
export const ECONOMIC_PAPERS: EconomicPaper[] = [
  ...
  },
  {
    ...
    icon: '📈',
    color: '#22c55e',
    summary: 'When you lock the margin at Cost+20%, the only way to grow platform benefit is to grow volume, and the only way to grow volume is to increase quality. The math doesn\'t let you cheat.',
    keyInsight: 'We flipped the sign. Quality now HELPS instead of hurts.',
    problemStatement: 'Normal businesses increase platform benefit by cutting costs, which usually means cutting quality.',
    solution: 'Lock the margin: Price = Cost × 1.20. Now dBenefit/dQuality becomes positive — quality attracts volume, volume is the only lever.',
    metrics: [
  ...
  },
  {
    ...
    problemStatement: 'Traditional economics treats generosity as a cost center — something that reduces platform benefit. This misses the value that generosity enables.',
    solution: 'Build generosity into the system as a contribution to potential. The corner of the field doesn\'t just help gleaners — it enables entire economies that wouldn\'t exist without that initial chance.',
    metrics: [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    solution: 'Joules are prepaid service access, not securities. Like arcade tokens, they\'re valuable within the system but cannot be traded externally.',
    metrics: [
  ...
  },
  {
    ...
    icon: '⚖️',
    color: '#6366f1',
    summary: 'Distribute patent participation across the community through the Sponsorship Cascade. 60% Platform Pool, 10% Patent Buckets, 20% Founder, 10% Prosecution.',
    keyInsight: 'Everyone can hold a piece of the intellectual property — not just backers.',
    problemStatement: 'Traditional IP participation concentrates in the hands of founders and backers.',
  ...
  {
    id: 'service-value-predictability',
    title: 'Service Value Predictability',
    subtitle: 'Structural Determinism',
    category: 'application',
    icon: '🎯',
    color: '#f97316',
    summary: 'When margin is locked at 20%, service value becomes predictable. No surprises, no manipulation, no extraction.',
    keyInsight: 'Predictable service value beats volatile value for long-term planning.',
    problemStatement: 'Traditional contributions have unpredictable service value due to market volatility and extraction.',
    solution: 'Lock the margin. Service value = 20% of cost, always. Volume determines total benefit, not margin manipulation.',
    metrics: [
      { label: 'Service Value', value: 20, unit: '%' },
  ...
  },
  {
    ...
    icon: '🏠',
    color: '#84cc16',
    summary: 'Members earn through their own enterprises — products, services, gigs. The platform provides infrastructure, not contribution-based payouts. Your business, your customers, your income.',
