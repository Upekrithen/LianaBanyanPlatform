...
## Status: Canonical baseline — unchanged from Feb 2 lock
...
*v014a preserves the Feb 2, 2026 Cardboard Boots lock verbatim for reference. Do not edit. See v014b (Path B merged) and v014c (Path C fresh) for iterations that integrate the B107-era R9 commons pledge and optional Patent Prosecution Defense Fund.*
