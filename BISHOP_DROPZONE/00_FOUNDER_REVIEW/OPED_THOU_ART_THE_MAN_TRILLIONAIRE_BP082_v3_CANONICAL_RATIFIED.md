...
subtitle: "Elon Musk just became the world's first trillionaire. I don't want to be that man. So we built the platform that refuses to make me, or anyone else, one."
class: op-ed / first-person essay
version: v3 CANONICAL (Founder edit pass · BP082 ratified)
publish_targets:
  - Cephas (lianabanyan.com)
  - Substack
  - Medium
  - Non-exclusive submission: The Atlantic · Wired · Fast Company · ProMarket · SSIR
  - NOT NYT (Six Easy Steps already in NYT queue per BP081)
authors: Jonathan "G.I." Jones, Founder, Liana Banyan Corporation
date: 2026-06-13
status: FOUNDER-RATIFIED v3 CANONICAL — READY TO PUBLISH
session: BP082
canon_anchors:
  - reference_capitalist_cooperative_rains_on_just_and_unjust_canon_bp082
  - reference_help_each_other_help_ourselves_catchphrase_canon_bp082
  - reference_patriotic_interdependentalist_canon
  - reference_participation_as_defense_canon
  - reference_three_currency_no_fiat_substitution_canon
  - BP059 Founder opening meditation lines 1-93
  - 1 Timothy 6:10 (love of money is the root) — Founder addition
  - Deuteronomy 25:4 (muzzle not the ox) — Founder addition
  - 1 Timothy 5:18 / Luke 10:7 (laborer worthy of hire) — Founder addition
v3_changes_from_v2:
  - subtitle: added "or anyone else"
  - "at least in agreed value" qualifier on Musk trillionaire
  - "It's not money anymore. It's become something entirely else." cadence
  - "prophet Nathan, and King David" — removed "a king named"
  - "Then Nathan said unto David" — added "Then"
  - Biographical specificity expanded: ARNG Montana age 16, then children's homes back in America, 2004 build date
  - "salt of the earth" added before "common man with common purpose"
  - "Money isn't the issue. It's the love of money." (1 Timothy 6:10) added
  - "Do Good Unto All Mankind" capitalized
  - "of many more" added to triple-citation framing
  - "Cooperative Corporate structure" replaces bare "structure"
  - "Muzzle not the Ox..." + "the laborer is worthy of his hire" added
  - "worker/builder/creator" added to creator-keeps math
  - "transparent accounting" added between "audited" and "no more"
  - "I am pointing at the structure that produced him and saying, no, thank you. It is refused." — Southern grace + flint
  - Three-beat callback restored per Founder direct: "Without structure, it is Me. It is every one of Us. It is, always, Us."
  - 95% lottery winners bankrupt within 5 years stat added
  - "Money doesn't make us different. It just lets us be more of who we already are." aphorism added
  - Yoda + Luke "You will be" Darth Vader anecdote added (Founder's preacher father quote)
  - Children-running-into-street parallel
  - "I only know a little bit of it in this arena, and I'm smart enough to keep it that way."
  - "the wisdom to turn it over to my betters as soon as possible"
  - "The patents are free to those who use them for free." conditional
v3_typo_fixes_applied:
  - "sine long before that" → "since long before that"
  - "willing run into the street" → "willingly run into the street"
v3_clarification_applied:
  - "a photograph of me with an ocean city" → "a photograph of me demonstrating in a pool a floating city design for the ocean"
word_count: ~1050
---

# VERSION 1 — Substack / Medium / Cephas
...
*Companion canon: [Capitalist Cooperative / Rains on the Just](mnemosynec.ai/about/) · [Universal Sustained Economic Prosperity](lianabanyan.com/papers/universal-prosperity/) · [How to Save the World in Six Easy Steps](lianabanyan.com/papers/save-the-world/) · [No Atomo. Superman!](lianabanyan.com/papers/no-atomo-superman/)*

---

---

# VERSION 2 — The Atlantic / Wired / Fast Company / ProMarket / SSIR

(Editorial outlet variant — Crewman #6 line dropped per non-insider audience; companion canon links footnoted out per house style)
...
I read this while building. I had been carrying this idea since 2003 — earlier, really since long before that, in sixth grade, when a newspaper article ran a photograph of me demonstrating in a pool a floating city design for the ocean, calling it the wave of the future. I am the child of missionaries in Africa, then raised in children's homes back in America while my parents fostered other people's children. I joined the ARNG in Montana when I was 16, and by 2004 when I was building what would become Liana Banyan, I was standing in a parking lot for hours on the one day a year a dentist gave free care, waiting to have an infected tooth pulled because it was making it hard to breathe. I was considering buying dog antibiotics at the pet store because I couldn't afford to take my daughter to the doctor. I was, by every measure, salt of the earth — a common man with common purpose: to do better than just eking by.
...
*Jonathan "G.I." Jones is the founder of Liana Banyan Corporation, a platform cooperative. He is an Army National Guard veteran and the author of How to Save the World in Six Easy Steps.*

---

## PITCH NOTE (paste above the piece in your submission email)

This piece is approximately 1,050 words. It is submitted simultaneously to select outlets per standard non-exclusive op-ed practice; you will be notified immediately upon acceptance elsewhere. I am the founder of Liana Banyan Corporation, a platform cooperative designed to structurally prevent founder wealth concentration. I am an Army National Guard veteran based in San Antonio, Texas. I can be reached at [your email].

## SUBMISSION EMAILS

- **The Atlantic:** ideas@theatlantic.com
- **Wired:** opinion@wired.com — Subject: *"Op-Ed Pitch: The platform that structurally refuses to make its founder a trillionaire."*
- **Fast Company:** fc.expert@fastcompany.com
- **ProMarket:** promarket@chicagobooth.edu
- **SSIR:** ssir@ssir.org

---

*v3 CANONICAL · Founder-edited · Bishop-typo-fixed · Sonnet 4.6 · 2026-06-13 · Ready to publish*
