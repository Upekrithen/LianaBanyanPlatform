...
**To:** Mark Zuckerberg, CEO · Yann LeCun, Chief AI Scientist
**Organization:** Meta
**Subject:** You made Llama free. Cooperative substrate makes the inference layer cooperative. Two complementary moves toward open AI economics.
...
Releasing Llama under open weights was the most consequential single decision in the AI economics story of the last three years. It reframed the debate from "who controls the frontier model" to "who controls the inference infrastructure." The model became a commons. The inference layer remained extractive.

Cooperative substrate closes that gap. The model is free. The routing layer is cooperative. The economics flow back to the people doing the inference work instead of the data-center intermediary.

These are not competing moves. They compose. Meta saves money on every Llama inference event that routes through cooperative substrate instead of Meta's own data centers. The savings flow back to Meta as a licensee at the 80/20 split. The open-weights ecosystem benefits because cooperative inference removes the cost ceiling that would otherwise limit deployment at the edge.
...
- **Cooperative substrate saves Meta approximately $300M–$1.5B per year** at substrate maturity. Mid-point estimate: **$900M/yr**.
- **License fee at 20% of measured savings: approximately $180M/yr** at mid-point.
- **Net savings to Meta: approximately $720M/yr.**
...
Meta's 2026 capex guidance of $115–135B is the most aggressive single-year AI infrastructure commitment of any company on this list. At that scale, even the conservative low-end savings figure ($300M/yr) represents material reduction in operating cost. At the high end ($1.5B/yr), cooperative substrate becomes one of the largest single-line infrastructure savings in Meta's financial model.

**Truth-Always caveat, per §17 BLOOD:** Substrate absorption rate (85–90%) is a forward projection at substrate maturity, not a Day 1 metric. Pilot-phase absorption is 10–20%. The inference fraction of Meta's compute spend is also estimated, not reported separately. These are "at maturity" savings figures with the reasoning chain visible.
