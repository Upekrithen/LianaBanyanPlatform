...
**Approach:** v014a (Feb 2 original) with three surgical additions:
1. One opening acknowledgment line
2. Patents paragraph updated to current numbers + reference #2260 Commons Pledge
3. Conditional Patent Prosecution Defense Fund paragraph added before the Board Chair Crown offer

Everything else: Feb 2 verbatim. Voice anchors preserved (potatoes, roommates, two suits, "I know enough to know I don't know enough", Rittenhouse).

---

# Cardboard Boots, Revisited: A Follow-Up for MacKenzie Scott

Dear Ms. Scott,

You may have seen my February open letter, *Cardboard Boots*. Since then, one specific piece of the work has accelerated in a way worth bringing to your attention directly. The ask of that first letter still stands — what follows is a narrow addition, not a replacement.
...
Every member can start a business for just 5 dollars, build their own designs or products, or get a job in another member's business — all under the same cooperative terms. Three commercial websites sustainably fund sixteen charitable initiatives through a baked-in 20% "Cost of Doing Good" margin. The infrastructure is backed by 2,265 documented innovations — 99% utility patents, not design — and 222 of them survived rigorous prior-art searches against the U.S. patent office with no prior art found anywhere. Thirteen provisional applications have now been filed. Under what we call the Cooperative Defensive Patent Pledge, 80 percent of that portfolio is contributed permanently to a commons — free for every nonprofit, cooperative, and academic institution, on the same cooperative terms as every member. What we need is people and leadership; the money will follow.
...
One accelerator, offered separately from everything above: the provisionals have a hard conversion deadline of November 26, 2026. Converting all thirteen — the prosecution work required to lock the commons permanently — is funded from inside the cooperative on the current math, but not in time for the full portfolio. If any slip the deadline, the commons is partial, and a partial commons can be enclosed. For that specific, bounded problem, we keep an arms-length vehicle — the Patent Prosecution Defense Fund inside Upekrithen LLC. Its sole purpose is prosecution; it dissolves when the patents convert. It accepts directed contributions at the five-to-ten-million level. No equity. No naming. No board seat. The fund dissolves. That option stays on the table and stays on the table — it is not the ask. The ask remains the introduction.
...
**Three surgical additions vs v014a:**
1. **Opening acknowledgment (one paragraph)** — positions v014b as a follow-up, not a replacement. Preserves "I don't want your money" as the hook of the second paragraph.
2. **Patents paragraph updated** — from "1,200 documented innovations, 99% utility patents, eight of which survived 130-query deep dive" → "2,265 innovations, 99% utility, 222 survived rigorous prior-art searches, 13 provisionals filed." Added one sentence naming the Cooperative Defensive Patent Pledge and the 80% commons / academics-free-forever framing.
3. **Patent Prosecution Defense Fund paragraph** — inserted between Red Carpet and Board Chair Crown. Honors the "not the ask" framing (matches Founder's voice). Bounded: specific amount, specific deadline, dissolves on completion, no equity, no naming. Uses "stays on the table and stays on the table" phrasing for integrity.

**What is NOT changed:**
- Roommate story (untouched)
- Potatoes line (untouched)
- Medallion sponsorship / bus-driver chain reaction (untouched)
- Board Chair Crown offer — remains the Crown offer, as in Feb 2 LOCKED
- Rittenhouse P.S. (untouched)
- Sign-off (untouched)
- "And I have two suits" (untouched)
- Break-even economics (untouched)

**Open questions for you:**
1. Is the opening acknowledgment the right framing, or should it be tighter / warmer?
2. Should v014b reference the April 29 NYT / Platformer launch, or leave that out (she might not see this before those dates anyway)?
3. The Defense Fund paragraph lands before the Crown. Should it land after? Or be a separate enclosure note rather than body prose?
