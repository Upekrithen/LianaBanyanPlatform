...
I'm launching the alpha by using half of my family's emergency savings to seed the launch through our medallion membership program: a no-strings-attached 100-dollar cooperative membership each to 10 waitresses, bus drivers, and laborers who would never otherwise see any of these opportunities to change their lives — a cooperative membership, not a financial instrument. Each recipient can share their membership forward into ten 10-dollar memberships, or more with involvement, bringing their own communities into the cooperative. One bus driver becomes ten transit workers becomes hundreds understanding they can have their own part of what they themselves and others work to achieve—the chain reaction that can go on for years.

One more thing: Liana Banyan amplifies the people it serves. We drive our audience to their storefronts, their channels, their practices. We don't ask members to amplify us. We amplify them. The louder they get, the louder the cooperative gets — because their success is our revenue, and our revenue is their influence.

Our economics show that 500 members in any locale reach break-even and around 1,000 they are sustainably self-funding, with surplus dedicated to local initiatives. Math says it's viable; my job is to prove it works in real life so others can count on it.
...
|---|----------|-------|--------|
| 1 | "community-owned safety net" | "community-operated cooperative" | "owned" implies securities/equity |
| 2 | "Liana Banyan Corporation" | "Liana Banyan Cooperative" | Corporate framing → cooperative framing |
| 3 | "medallion sponsorship program" | "medallion membership program" | "sponsorship" ambiguous near securities |
| 4 | "sustainably profitable" | "sustainably self-funding" | "profitable" implies profit distribution |
| 5 | "1,200 documented innovations" | "1,935 documented innovations" | Updated count |
| 6 | "eight of which survived..." | "1,401 formal claims across eight provisional applications that survived..." | Updated patent stats |
| 7 | Added "a cooperative membership, not a financial instrument" | After medallion membership description | Explicit SEC disclaimer |
| 8 | Added Amplifier Clause | Before economics paragraph | Innovation #1907 |
