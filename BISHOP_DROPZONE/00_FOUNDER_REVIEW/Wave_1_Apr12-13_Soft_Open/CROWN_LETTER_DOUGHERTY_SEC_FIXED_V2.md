...
## Board Candidate, Liana Banyan Cooperative
...
I've spent four decades being one.
...
I'm a {{founderAge}}-year-old ARNG veteran — Infantry (11B) and Aviation (15A), helicopter pilot with FAA Commercial Rotary Wing IFR rating. Father of eight. 21 years in IT development. 2118 on a good day — nowadays I hover in the 2080s when I take a chess break from work.

I'm an amateur engineer who built the thing. I changed my major in college from Architecture to a double major of Bible and Business, with a minor in Art — but I never stopped designing. I was the child of missionaries in Tanzania — we left on the last flight before Idi Amin's invasion. Back in the States, my parents fostered children in our home when I was 8yrs old; for 5 years. We had no television until I was 13 in Montana, so I read a lot, tinkered with everything I could get my hands on, and got good at chess.

I've been thinking about cooperative economics for four decades. Building this specific platform for nine. Ludicrous speed for the last five months. I have 18 handwritten journals documenting every iteration, early prototypes from 2003 when I was active duty Army, SolidWorks files from before that, and 1,200+ Fusion 360 diagrams from recent years. 170+ innovations with 928 patent claims filed since November 26, 2025 — the last 44 about ten minutes ago.

One of our fifteen initiatives is called **Let's Make Bread**. It's a business incubator. And I need someone who understands what it means to empower makers to lead it.

I don't want to be CEO. I want to build, invent, solve problems. That's why I need Crowns.
...
Liana Banyan is a member-operated cooperative platform in which three commercial divisions — .com, .biz, and .net — drive sustained funding for Fifteen charitable initiatives across food security, healthcare access, education, financial inclusion, and crisis response. All the time, by design, sustainable beyond our lifetimes because of the infrastructure we build that operates far beyond us.

The economic principle is simple: **Cost + 20%**. Creators keep 83.3% of every transaction. The platform takes 16.7% to fund operations, and 100% of charitable funds go directly to the people doing the work. Of the people, by the people, and for the people.
...
**HexIsle** is my contribution to that infrastructure — a modular hydraulic gaming table system designed to be manufactured at scale while remaining accessible to makers. It's physical computing. It's the Tereno Platform. It's what happens when a maker spends four decades thinking about how things fit together.

The real unlock is manufacturing. HexIsle proves a single person with an SLA 3D printer, molding materials or desktop extruders and elbow grease can produce precision components at 95% less cost than traditional manufacturing. Ask me how I know. And modular design means the same product can be made in a garage in Texas or an apartment in Tokyo. We're not building one factory — we're enabling thousands of tiny ones, each owned by the person running it. And all ancillary service businesses.
...
| **Operational Allocation** | Percentage of Let's Make Bread business side resource allocation in perpetuity |
...
- **Jose Andres** for Let's Get Groceries — food access
...
The ecosystem is forming. You wouldn't be leading an isolated initiative — you'd be part of an ecosystem of hundreds that lead thousands to benefit millions.
...
Modular game systems since 1978. 1,200+ Fusion 360 diagrams for HexIsle alone. A patent portfolio with 170+ innovations and 470+ claims filed. And a platform designed to help other makers do what I'm doing.
...
No one else is getting this letter for Industry Chancellor.
...
I'd be grateful for a referral. Who do you know in the maker movement who might be right for this?

---

## THE CONNECTION

The first Industrial Revolution built factories.
The second one is supposed to empower makers.
...
**Jonathan Jones**
Founder, Liana Banyan Cooperative
...
| 2 | "Founder's Reserve Stake" + "Significant equity stake in Liana Banyan" | "Founder's Reserve Allocation" + "Significant allocation authority in Liana Banyan" | "Stake"/"equity" implies securities ownership |
| 3 | "Revenue Share" + "Percentage of Let's Make Bread business side revenue in perpetuity" | "Operational Allocation" + "Percentage of Let's Make Bread business side resource allocation in perpetuity" | "Revenue Share" implies profit distribution |
| 4 | "cooperative platform" (WHAT I'VE BUILT section) | "member-operated cooperative platform" | Clarifies operational model, avoids "community-owned" |
| 5 | Added Amplifier Clause | In THE CONNECTION section | Innovation #1907 — cooperative IP model |

*BISHOP — SEC-Fixed V2 — Session 028 — March 23, 2026*
*Source: CROWN_LETTER_DALE_DOUGHERTY_FINAL.md*
