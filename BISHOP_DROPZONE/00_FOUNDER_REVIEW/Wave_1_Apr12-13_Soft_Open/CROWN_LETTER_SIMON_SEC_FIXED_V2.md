...
### CFO — Liana Banyan Cooperative (Offered)
...
Before building any of this, we conducted 130 prior art searches across 12 innovation categories, reviewing 330+ existing patents against our portfolio of 1,243 documented innovations — 99% utility patents, not design — protected by 210 formal claims across 7 applications. Eight have already cleared deep prior-art review with no prior art found, with more under evaluation — we call the confirmed survivors the Crown Jewels. The full research — every query, every result, every search log, every dual-AI valuation assessment — is published at lianabanyan.com/cephas/ in the "Under the Hood" section. Nothing is behind an NDA or a paywall. I am inviting you to verify every claim against the source material.

This is standard procedure for what we call the Press Junket: a standing invitation for domain-verified professionals to evaluate our work publicly. The feedback tool at lianabanyan.com/cephas/ is exclusively for credentialed reviewers — we have a slot reserved specifically for you that accepts submission from your @simoninvestigations.com or @alumni.clemson.edu domain email. No contact is made between us before or during your review — this preserves the empirical value of an independent expert assessment. You publish what you find, in your own words, with no editorial input from us. What happens after is entirely up to you. We welcome professional evaluation precisely because we want to do it *right*. An uncoached critique from a 26-year FBI forensic accountant is worth more to our members than anything we could write about ourselves.

As a standard professional courtesy, every credentialed reviewer who signs in through the Press Junket receives the equivalent of what our $5,000 Members receive — full platform access at the Member tier, regardless of what they find. This isn't compensation for your opinion. It's a standing offer to every domain-verified professional who lends their credentials to the process, so you can evaluate the system from the inside, not just the documentation.
...
I'm a {{founderAge}}-year-old ARNG veteran (Infantry and Aviation), IFR-rated helicopter pilot, father of eight, with 21 years in IT development. The platform's IP backbone is 1,243 innovations, protected by 210 formal claims across 7 applications; eight have already cleared deep prior-art review, with more under evaluation.
...
2. Full research archive: lianabanyan.com/cephas//under-the-hood/patent-prior-art-research/
3. Platform walkthrough: LianaBanyan.com/RedCarpet (personalized for @simoninvestigations.com)
4. Economics deep dive: lianabanyan.com/cephas//under-the-hood/
...
|---|----------|-------|--------|
| 1 | "Liana Banyan Corporation" (header, body, sign-off) | "Liana Banyan Cooperative" | Corporate framing → cooperative framing |
| 2 | "$5,000 Sponsors receive — full platform access at the Sponsor tier" | "$5,000 Members receive — full platform access at the Member tier" | "Sponsor" near financial context → "Member" to avoid securities implication |
| 3 | Added Amplifier Clause | After "The Ask" section | Innovation #1907 — cooperative IP model |

*BISHOP — SEC-Fixed V2 — Session 028 — March 23, 2026*
*Source: CROWN_LETTER_TOM_SIMON_CFO_007.md*
