...
People I love are domestic abuse survivors.

In addition, my missionary parents fostered children in our family home back in the States for five years when I was 8 to 13. I know the stories that they would never tell an adult.

That's why I'm writing to you. That's why I've spent 40+ years thinking and nine years building a platform that includes, at its core, a protection system for people who need to escape, hide, heal, and start over.

I can't do everything. But I can do something. This. And so can a lot of people.

My name is Jonathan Jones. I'm a {{founderAge}}-year-old father of eight, a U.S. ARNG veteran, and the founder of Liana Banyan Cooperative — a member-operated cooperative commerce platform with fourteen charitable initiatives designed to be sustainably self-funding. I was the child of missionaries in Tanzania — no television until 13, so I read a lot, and I'm good at chess. I'm not a billionaire. I'm not famous. I'm just someone who wants what should be good to ACTUALLY BE GOOD. The systems we have aren't protecting or helping people well enough, and arguably are part of the problem. So I've designed different ones.
...
Liana Banyan is a member-operated cooperative platform in which three commercial divisions — .com, .biz, .net — drive sustained funding for the .org charitable initiatives. All the time, by design, sustainable beyond our lifetimes because of the infrastructure we build that operates far beyond us.
...
Within that platform, we have fourteen initiatives — everything from meal delivery (Let's Make Dinner) to music licensing (JukeBox) to microloans (VSL). Each one is designed to be sustainably charitable: communities fund them, communities run them, communities benefit.
...
| **Founder's Reserve Allocation** | Allocation authority in Liana Banyan |
...
| 2 | "self-funding and sustainable" (intro paragraph) | "sustainably self-funding" | Consolidates language, avoids "profitable" |
| 3 | "Founder's Reserve Stake" + "Equity in Liana Banyan" | "Founder's Reserve Allocation" + "Allocation authority in Liana Banyan" | "Stake"/"equity" implies securities ownership |
| 4 | "Revenue Share" + "Percentage of Defense Klaus business side revenue in perpetuity" | "Operational Allocation" + "Percentage of Defense Klaus business side resource allocation in perpetuity" | "Revenue Share" implies profit distribution |
| 5 | "cooperative platform" (WHAT I'VE BUILT) | "member-operated cooperative platform" | Avoids "community-owned" implication |
| 6 | Added Amplifier Clause | After WHAT I'M ASKING section | Innovation #1907 — cooperative IP model |

*BISHOP — SEC-Fixed V2 — Session 028 — March 23, 2026*
*Source: CROWN_LETTER_RUTH_GLENN_UPDATED.md*
