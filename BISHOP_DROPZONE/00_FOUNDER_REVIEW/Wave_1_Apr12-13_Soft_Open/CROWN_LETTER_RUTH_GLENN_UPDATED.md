...
The economic principle is simple: **Cost + 20%**. Creators keep 83.3%+ of every transaction. The 20% funds operations, and 100% of charitable funds go directly to the people doing the work.

Within that platform, we have 16 initiatives — everything from meal delivery (Let's Make Dinner) to music licensing (JukeBox) to microloans (VSL). Each one is designed to be sustainably charitable: communities fund them, communities run them, communities benefit.
