...
*Cooperative substrate hero statistics (benchmarked receipts): **97% Faster - 98% Accurate - 95% Cheaper** vs centralized flagship inference · full receipts at lianabanyan.com/proofs/ · substrate download at mnemosynec.org/download*
...
The UIP is an additional economic mechanism layered on top of both license tiers. Tier 1 and Tier 2 licensees both receive UIP access. All eight licensed AI companies participate in a single competitive marketplace for member IP disclosures. No exclusivity applies in either direction -- neither LB exclusive to any single company, nor any single company exclusive to LB.

Members route IP disclosures to their preferred receiving company at the moment of disclosure -- a per-disclosure choice, not a per-relationship lock-in. The IP Ledger records each pickup: member ID, disclosure hash, receiving company ID, tier at pickup, timestamp, and disclosure category. Records replicate through the Frontier Mesh (content-addressed, tamper-evident). If a company declines or ignores a disclosure (no ACK within 30 calendar days), the member may re-route to any other licensed company with the original stamp date preserved as prior-art anchor.

Companies compete for innovator pipeline access by being the most attractive destination -- by reputation, prior pickup rate, bounty rates paid, and member treatment quality. The cooperative publishes aggregate routing stats annually as competitive discipline. The constraint is popularity, not time.
