<!-- FIRE INSTRUCTIONS -->
<!-- PLATFORM: Medium (cross-publish after Substack goes live) -->
<!-- ACTION: Paste body below into Medium editor. Replace URL_PLACEHOLDER with the live Substack URL. Replace DATE_PLACEHOLDER with publish date (e.g. June 17, 2026). -->
<!-- ORDER: Substack publishes FIRST. Medium cross-publishes immediately after with canonical-link footer active. -->
<!-- TITLE FIELD: Just Add Salt. How to Get the Right Answer. -->
<!-- SUBTITLE / DESCRIPTION FIELD: 68 of 70. On a consumer laptop. No paid API keys. Here is the architecture. -->
...
*Originally published at [FounderDenken Substack](URL_PLACEHOLDER) on [DATE_PLACEHOLDER].*
