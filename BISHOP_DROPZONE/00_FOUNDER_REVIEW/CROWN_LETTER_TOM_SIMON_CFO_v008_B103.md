...
Liana Banyan Corporation is a cooperative commerce platform — sixteen charitable initiatives funded by three commercial websites, where every creator, and worker, keeps 83.3% of revenue generated and the platform margin is permanently locked at Cost + 20%. The operating agreement makes extraction structurally impossible.

We use blockchain strictly as an immutable ledger — for intellectual property provenance, transaction audit trails, and internal valuation markers. Not on a public mainnet. Not tradeable. Not redeemable for cash. Never used to raise money. We call it "Test-Net By Design": our provenance layer lives permanently on a test network, not as a staging step before mainnet, but as a deliberate architectural choice to prevent speculation from ever being possible.

Our internal currencies (Credits, Marks, and Joules) are closed-loop service units — they work like arcade tokens: you can earn them, spend them inside the system, but you cannot sell them, transfer them, or cash them out. Period.

The value of our blockchain medallions, in my view, is precisely that they have no intrinsic value. They only signify — immutably — the actual dynamic value of the intellectual property they represent. The medallion isn't the asset. The innovation is the asset. The medallion is the notarized receipt that proves the innovation exists, when it was documented, and who contributed to it. That receipt can't be traded because it *shouldn't* be traded. It's evidence, not currency.

**One related note:** We recently formalized the AI coordination layer that makes all of this possible at scale — the **Romulator 9000**, filed on Provisional Patent Application 64/036,646 on April 12, 2026. Its architecture is built on the same receipt-chain principle: every scheduled operation leaves a dated, cryptographically-bound receipt; a watchdog catches any job that failed to fire. Silent failure is structurally impossible. A forensic accountant would recognize the design — it is audit discipline applied to software. The CFO seat at Liana Banyan will own oversight of both the blockchain provenance chain and the Romulator receipt architecture.

And we treat it as "garbage in, garbage forever" if we're not careful — which is why the CFO seat owns controls over what gets notarized in the first place.
...
Before building any of this, we conducted more than **200 prior art searches** across 12 innovation categories, reviewing hundreds of existing patents against our portfolio of **2,263 documented innovations** — 99% utility patents, not design — protected by approximately **2,412 formal claims** across **13 provisional applications**, with **222 confirmed Crown Jewels** that cleared deep prior-art review with no prior art found. The full research — every query, every result, every search log, every dual-AI valuation assessment — is published at Cephas.LianaBanyan.com in the "Under the Hood" section. Nothing is behind an NDA or a paywall. I am inviting you to verify every claim against the source material.

This is standard procedure for what we call the Press Junket: a standing invitation for domain-verified professionals to evaluate our work publicly. The feedback tool at Cephas.LianaBanyan.com is exclusively for credentialed reviewers — we have a slot reserved specifically for you that accepts submission from your @simoninvestigations.com or @alumni.clemson.edu domain email. No contact is made between us before or during your review — this preserves the empirical value of an independent expert assessment. You publish what you find, in your own words, with no editorial input from us. What happens after is entirely up to you. We welcome professional evaluation precisely because we want to do it *right*. An uncoached critique from a 26-year FBI forensic accountant is worth more to our members than anything we could write about ourselves.
...
I'm offering you a Crown. In our structure, a Crown is a permanent leadership seat — in this case, the CFO seat for Liana Banyan Corporation. The CFO oversees financial integrity, regulatory compliance, and the audit architecture that protects every member's interests.

More specifically: the CFO is one of three or four humans who form what we call the Irreducible Center — the minimum viable team that holds platform legal, treasury operations, multi-state compliance, and cross-initiative coordination in place while the cooperative's Nodes launch in cities and towns across the country. The Center cannot be decentralized. Someone has to hold the line. That someone, in the financial lane, is the CFO. If a cooperative's finances can't withstand forensic scrutiny, it doesn't deserve to exist. I want someone in that seat who spent a career making sure that scrutiny happens.
...
If you'd prefer not to sit in the seat yourself but know someone who should — that is equally valuable to me. A Crown holder can appoint and mentor the person they place into the role. You would be the French Fleet for your appointed CFO — the veteran commander whose presence keeps everyone honest. That mentorship *is* what being the Crown means. You don't have to run the finances day-to-day. You just have to make sure the person who does has your standards.
...
I'm a {{founderAge}}-year-old ARNG veteran (Infantry and Aviation), IFR-rated helicopter pilot, father of eight, with 21 years in IT development. The platform's IP backbone is 2,263 innovations protected by approximately 2,412 formal claims across 13 provisional applications, with 222 Crown Jewels confirmed with no prior art.
...
2. Full research archive: Cephas.LianaBanyan.com/under-the-hood/patent-prior-art-research/
3. Platform walkthrough: LianaBanyan.com/RedCarpet (personalized for @simoninvestigations.com)
4. Economics deep dive: Cephas.LianaBanyan.com/under-the-hood/
