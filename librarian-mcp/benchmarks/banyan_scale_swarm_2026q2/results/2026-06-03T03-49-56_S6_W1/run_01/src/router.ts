...
import { handleCreateUser, handleGetUser, handleListUsers, handleUpdateUser, handleDeleteUser } from './controllers/user.controller.js';
import { handleCreateProduct, handleGetProduct, handleListProducts, handleUpdateProduct, handleDeleteProduct } from './controllers/product.controller.js';
import { handleCreateOrder, handleGetOrder, handleGetOrdersByBuyer, handleUpdateOrderStatus } from './controllers/order.controller.js';
