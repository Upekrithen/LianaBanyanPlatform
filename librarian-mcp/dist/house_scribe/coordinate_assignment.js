 ...
 */
import { buildCoordinate, validateCoordinate, cellPrefix, jarSlot, cathedralToId, swarmDaughterCell, coordinateMatchesQuery, parseWildcardQuery, MAX_JARS_PER_CELL, WILDCARD_RESULT_CAP, } from "./coordinate_scheme.js";
import { readAllJars, indexJar } from "./jar_lifecycle.js";
 ...
 */
function occupiedSlots(allJars, prefix) {
 ...
 */
function nextAvailableSlot(occupied) {
 ...
 */
export function assignCoordinate(opts) {
    ...
    for (let attempt = 0; attempt < 99; attempt++) {
        ...
        if (slot !== null) {
            const coordinate = buildCoordinate(currentPrefix.split("-")[0], currentPrefix.split("-")[1], currentPrefix.split("-")[2], slot);
 ...
 */
export function queryJarsByCoordinate(pattern, opts = {}) {
...
//# sourceMappingURL=coordinate_assignment.js.map
