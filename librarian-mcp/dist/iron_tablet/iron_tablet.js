...
// ─── Default scribe ID ────────────────────────────────────────────────────────
function defaultScribeId() {
    return (process.env.IRON_TABLET_SCRIBE_ID ?? "iron_tablet_default");
}
// ─── Public API ───────────────────────────────────────────────────────────────
/**
 ...
 */
export async function ironTabletWrite(params) {
    const enriched = {
        ...params,
 ...
 */
export async function ironTabletRead(ebletPath) {
 ...
 */
export async function ironTabletProvenance(ebletPath) {
 ...
 */
export async function ironTabletList(dir) {
...
//# sourceMappingURL=iron_tablet.js.map
