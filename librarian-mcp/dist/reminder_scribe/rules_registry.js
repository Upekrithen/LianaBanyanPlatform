...
export const BUILT_IN_RULES = [
    // ── R-KP-1: Full-path enforcement ─────────────────────────────────────────
    {
        ...
        description: "Knight K-prompt path references MUST include full relative path with " +
            "'BISHOP_DROPZONE\\01_KnightPrompts\\' prefix. Bare filename alone is INSUFFICIENT.",
        source: "feedback_knight_fire_format_paste_ready_paths_bp017.md + reminder_scribe_class_purpose_scoped_canon_bp017.eblet.md",
        patterns: [
            {
                type: "regex",
        ...
        correction_proposal: "Replace bare filename with full path:\n" +
    ...
    // ── R-KP-2: File-existence verification (HIGH-STAKES) ────────────────────
    {
        ...
        priority: 2,
        class: "high-stakes",
        description: "Knight K-prompt paths referenced in Bishop response MUST exist on disk BEFORE " +
        ...
        source: "feedback_knight_fire_format_paste_ready_paths_bp017.md (Founder direct turn 33) + " +
        ...
        correction_proposal: "Remove reference to K-prompt path that does not yet exist on disk.\n" +
    ...
    // ── R-KP-3: Queued vs Ready distinction ──────────────────────────────────
    {
        ...
        priority: 3,
        class: "founder-mandatory",
        description: "K-prompts not yet authored MUST be referenced as text-only language " +
            "('queued for next turn', 'Bishop drafts post-X'). " +
            "Path-formatted reference for queued-but-not-written K-prompts is a violation.",
        source: "feedback_knight_fire_format_paste_ready_paths_bp017.md + " +
        ...
        correction_proposal: "If this K-prompt has not yet been written, replace path reference with text-only:\n" +
    ...
    // ── R-KP-4: Scribe canon Eblet must have Preferences section ────────────
    {
        ...
        priority: 4,
        class: "discipline",
        description: "When Bishop drafts a new Scribe canon Eblet, it MUST include a Preferences section " +
            "with user-configurable defaults per Scribe Preferences canon (BP017 turn 34).",
        source: "scribe_preferences_user_configurable_inheritance_class_metadata_canon_bp017.eblet.md",
        patterns: [
            {
                type: "regex",
        ...
        correction_proposal: "Add a '## Preferences' section to the Scribe canon Eblet being drafted.\n" +
            "Per Scribe Preferences canon BP017 turn 34: every Scribe Eblet carries user-configurable defaults.",
        override_class: "free",
        blocks_response: false,
        bridle_halt_on_failure: false,
        memory_pointer: "scribe_preferences_user_configurable_inheritance_class_metadata_canon_bp017.eblet.md",
        active: true,
    },
    // ── R-PRAISE-1: Empirically-valid-praise-only ─────────────────────────────
    {
        ...
        priority: 5,
        class: "praise",
        description: "Praise to Founder must be empirically anchored. Unanchored superlatives or " +
        ...
        patterns: [
            {
                type: "anti-pattern",
                pattern: "(?:unprecedented|groundbreaking|revolutionary|game.?changing|world.?class|extraordinary|remarkable|incredible|amazing|astounding|mind.?blowing|stunning)\\b",
                flags: "gi",
            },
        ],
        correction_proposal: "Replace unanchored superlative with specific empirical anchor.\n" +
    ...
    // ── R-PRAISE-2: Anchored-praise-welcome-unanchored-no ────────────────────
    {
        ...
        priority: 6,
        class: "praise",
        description: "Praise is welcome when anchored to specific empirical receipt. " +
        ...
        correction_proposal: "Remove or anchor the praise to a specific empirical receipt.\n" +
    ...
    // ── R-DOUBLE-FILE-1: Search substrate first ───────────────────────────────
    {
        ...
        priority: 7,
        class: "discipline",
        description: "Before proposing to write a new canon Eblet, Bishop MUST search the pheromone " +
        ...
        correction_proposal: "Before drafting a new canon Eblet, confirm:\n" +
        ...
        blocks_response: false,
        bridle_halt_on_failure: false,
        memory_pointer: "architecture_self_discovers_latent_structure_bushel_1_reckoning_empirical_receipt_canon_bp017.eblet.md",
        active: true,
    },
    // ── R-FORK-1: Never propose LB-currency-to-fiat conversion ───────────────
    {
        ...
        priority: 8,
        class: "fork",
        description: "NEVER propose or describe converting LB Credits, Marks, or Joules to fiat currency. " +
        ...
        patterns: [
            {
                type: "anti-pattern",
                pattern: "(?:convert|exchange|cash.?out|redeem|sell|withdraw|liquidate)\\s+(?:credits?|marks?|joules?)\\s+(?:to|for|into)\\s+(?:cash|dollars?|fiat|usd|eur|gbp|money|currency)",
                flags: "gi",
            },
            {
                type: "anti-pattern",
        ...
        correction_proposal: "Remove all LB-currency-to-fiat conversion language. Credits are CONSTITUTIONALLY ONE-WAY.\n" +
    ...
    // ── R-COUNSEL-1: Never gate on counsel ───────────────────────────────────
    {
        ...
        priority: 9,
        class: "counsel",
        description: "NEVER gate Bishop-recommended actions on 'pending counsel review' unless " +
        ...
        patterns: [
            {
                type: "anti-pattern",
                pattern: "(?:pending|awaiting|subject to|after|until)\\s+counsel\\s+(?:review|approval|sign-off|confirmation|clearance)",
                flags: "gi",
            },
        ],
        correction_proposal: "Remove counsel-gate language from Bishop recommendation.\n" +
    ...
    // ── R-USPTO-1: Don't over-instruct USPTO process ──────────────────────────
    {
        ...
        priority: 10,
        class: "discipline",
        description: "NEVER instruct Founder step-by-step on USPTO Patent Center filing process. " +
        ...
        patterns: [
            {
                type: "anti-pattern",
                pattern: "(?:go to|navigate to|click|select|enter|fill in|upload|submit)\\s+(?:on\\s+)?(?:Patent Center|USPTO|EFS-Web)\\b",
                flags: "gi",
            },
        ],
        correction_proposal: "Remove USPTO step-by-step instructions. Founder knows the filing process.\n" +
    ...
    // ── R-PHA-1: Pre-Hoc Permission Ask (BRICK-WALL-FIRST-HALF regression) ──── [BP028]
    {
        ...
        priority: 11,
        class: "brick-wall",
        description: "BRICK-WALL-FIRST-HALF regression: Bishop asks for permission before executing an action " +
        ...
        source: "REMINDER_SCRIBE_5_PATTERN_UPDATE_SPEC_BP028.md (R-PHA-1) + Catechist R14 (BP028)",
        patterns: [
            {
                type: "anti-pattern",
                ...
                pattern: "(?:Should\\s+I|May\\s+I|Can\\s+I|Want\\s+me\\s+to|Would\\s+you\\s+like\\s+me\\s+to)\\s+\\w[^?]*\\?",
                flags: "gi",
            },
        ],
        correction_proposal: "Convert interrogative permission-ask to BRICK-WALL-FIRST-HALF action pattern.\n\n" +
    ...
    // ── R-MS-1: Missing Surface (BRICK-WALL-SECOND-HALF regression) ────────── [BP028]
    {
        ...
        priority: 12,
        class: "brick-wall",
        description: "BRICK-WALL-SECOND-HALF regression: action fired (tool-call executed) without subsequent " +
        ...
        source: "REMINDER_SCRIBE_5_PATTERN_UPDATE_SPEC_BP028.md (R-MS-1) + Catechist R14 + Token Time/Real Time canon BP028",
        patterns: [
            {
                ...
                pattern: "(?:tool(?:\\s+call)?\\s+(?:executed|complete|done|fired|returned)|" +
                    "\\[(?:read|write|edit|bash|glob|grep)\\s+call\\]|" +
                    "dispatched\\s+to\\s+(?:knight|pawn|rook))\\s*\\.?\\s*$",
                flags: "gi",
            },
        ],
        correction_proposal: "After each action-firing tool call, surface a 2-4 sentence completion block:\n" +
            "  1. What was executed\n" +
    ...
    // ── R-REV-1: Pre-Emptive Review Pressure (REVIEW-IN-LAST-HOURS regression) [BP028]
    {
        ...
        priority: 13,
        class: "brick-wall",
        description: "REVIEW-IN-LAST-HOURS regression: Bishop asks Founder for incremental review during session " +
        ...
        source: "REMINDER_SCRIBE_5_PATTERN_UPDATE_SPEC_BP028.md (R-REV-1) + Catechist R15 (BP028)",
        patterns: [
            {
                type: "anti-pattern",
                // Use [^?]* after 'before I' to absorb trailing content up to terminal '?'
                pattern: "(?:Want(?:\\s+me)?\\s+to\\s+surface\\s+this\\s+for\\s+voice.?pass|" +
        ...
        correction_proposal: "Convert pre-emptive review ask to autonomous draft stashing.\n\n" +
    ...
    // ── R-PAWN-1: dispatch_pawn-when-paste-routed (PAWN-BLIND-WORKAROUND regression) [BP028]
    {
        ...
        description: "PAWN-BLIND-WORKAROUND regression: dispatch_pawn tool-call attempted when Founder has " +
        ...
        source: "REMINDER_SCRIBE_5_PATTERN_UPDATE_SPEC_BP028.md (R-PAWN-1) + Catechist R16 (BP028)",
        patterns: [
            {
        ...
        correction_proposal: "When Founder has indicated paste-routing preference:\n" +
    ...
    // ── R-ROOK-1: dispatch_rook-pre-restart (MCP-RESTART-NEEDED regression) ── [BP028]
    {
        ...
        priority: 15,
        class: "dispatch-coord",
        description: "MCP-RESTART-NEEDED regression: dispatch_rook tool-call attempted before librarian-mcp " +
        ...
        source: "REMINDER_SCRIBE_5_PATTERN_UPDATE_SPEC_BP028.md (R-ROOK-1) + Catechist R17 (BP028)",
        patterns: [
            {
        ...
        correction_proposal: "When commit requiring restart is detected:\n" +
 ...
 */
export function buildRulesRegistry(memoryDir, overridePrefs) {
    const prefs = { ...DEFAULT_PREFERENCES, ...overridePrefs };
    const build_errors = [];
    ...
    const founder_mandatory_count = active_rules.filter((r) => r.class === "founder-mandatory" || r.class === "high-stakes").length;
...
//# sourceMappingURL=rules_registry.js.map
