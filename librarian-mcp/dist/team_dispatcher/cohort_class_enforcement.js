...
export function getScribeAccessDescriptor(cohortClass) {
 ...
 */
export function enforceAllowedCathedrals(requested, cohortClass) {
 ...
 */
export function canWriteBack(cohortClass) {
 ...
 */
export function buildAccessAuditSummary(cohortClass, requestedCathedrals, requestedWriteBack) {
    const descriptor = ACCESS_RULES[cohortClass];
...
//# sourceMappingURL=cohort_class_enforcement.js.map
