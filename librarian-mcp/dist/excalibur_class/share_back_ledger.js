 ...
 */
export function recordShareBackForPayment(sliceId, members, subscriptionRevenue, periodStart, periodEnd) {
...
export function markShareBacksPaidOut(entryIds) {
    const now = new Date().toISOString();
 ...
 */
export function getShareBackSummaryForSlice(sliceId) {
...
//# sourceMappingURL=share_back_ledger.js.map
