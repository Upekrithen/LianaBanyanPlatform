...
export function resolveEbletPath(ebletPath: string): string {
...
export function ebletWrite(params: {
  ...
  scribeId: string;
}): { ebletHash: string; conflict?: ConcurrencyConflict } {
  ...
  let conflict: ConcurrencyConflict | undefined;
