...
server.tool(
  ...
  "KN-J2 / BP017 — House Scribe: assign 8-digit grid coordinate to a Jar (indexed state transition). " +
...
server.tool(
  ...
  "KN-J2 / BP017 — House Scribe: coordinate-based Jar query. " +
...
server.tool(
  ...
  "KN-J3 / BP017 — House Scribe: fire Pixie Dust / Pheromone-write event on a grid cell. " +
...
server.tool(
  ...
  "KN-J3 / BP017 — House Scribe: query living cell state for a coordinate. " +
...
server.tool(
  ...
  "KN-J3 / BP017 — House Scribe: full living-gridwork snapshot. " +
...
server.tool(
  ...
  "KN-J3 / BP017 — House Scribe: detect and reconcile cell-state inconsistencies. " +
...
server.tool(
  ...
  "KN-J4 / BP017 — House Scribe: handle Hive-thread closure event. " +
...
server.tool(
  ...
  "KN-J4 / BP017 — House Scribe: query Jars created from a Hive thread. " +
...
server.tool(
  ...
  "KN-J5 / BP017 — House Scribe: cross-cathedral Jar query via 8-digit-grid coordinate patterns. " +
...
server.tool(
  ...
  "KN-J5 / BP017 — House Scribe: invalidate cross-cathedral query cache. " +
...
server.tool(
  ...
  "KN-J5 / BP017 — House Scribe: query the cross-cathedral query provenance log. " +
