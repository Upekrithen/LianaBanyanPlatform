...
import type { CephasIndex, CephasEntry } from "../types.js";

export async function parseCephas(workspaceRoot: string): Promise<CephasIndex> {
  ...
  const entries: Record<string, CephasEntry> = {};
